...
class DeviceVectorAlpaka
{
  ...
  public:
    ...
    DeviceVectorAlpaka() = default;

    // Construct with a number of elements
    explicit DeviceVectorAlpaka(size_type count);

    // Swap with another vector
    inline void swap(DeviceVectorAlpaka& other) noexcept;
...
// Swap two vectors
template<class T>
inline void swap(DeviceVectorAlpaka<T>&, DeviceVectorAlpaka<T>&) noexcept;
