...
TEST_F(TrackInitTest, run)
{
    ...
    // count the number of secondaries produced in each interaction. If a track
    // that produced secondaries was killed, fill that track slot with the
    // first secondary.
    track_init.find_vacancies(states, params);
